  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <div className='overflow-x-auto p-4'>
        <div className='group flex flex-wrap gap-4 mt-4 w-full'>
          {nowPlayingMovies.map((movie) => (
            <div key={movie.id} className={`relative w-full sm:w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300`} onClick={() => setSelectedMovie(movie.id)} >
